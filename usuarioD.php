...
ini_set('display_errors', 1);
   ...
   error_reporting(E_ALL);
        ...
        <div class="container-fluid">
			...
			<div class="navbar-nav">
                <a class="nav-link active" aria-current="page" href="login3.php">Ingresar a la aplicación</a>
            </div>
            </div>
        </div>
        </nav>
		<form method="POST" 
			...
			<fieldset class="mt-5 mx-5">
				<legend>Registro de usuarios</legend>
			<label>No. de Registro:</label><br/>
			<input style="color: black;" type="text" name="id" value ="<?php echo $numero;?>" disabled/>
			<label>Nombre:</label>
			...
			<input id="enviarr"  class="mt-4" type="submit" name="enviar" value="Enviar datos"/>
			<script>
